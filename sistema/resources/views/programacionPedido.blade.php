    ...
    <div class="panel panel-default table-responsive">
     <!--     <div class="panel-heading">
        ...
        <div style="padding-top:10px; padding-bottom: 20px;padding-left: 20px">
            ...
            @endif
            @if( ($pedido[0]->tipoCarga==1 or $pedido[0]->tipoCarga==2 ) and $pedido[0]->idFormaEntrega==2 and (Session::get('idPerfil')=='5' or Session::get('idPerfil')=='6' or Session::get('idPerfil')=='7') and $sinDespachar>0 )
